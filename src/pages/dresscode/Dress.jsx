  ...
  const dressCodeSections = [
    {
      ...
      answer: (
        <>
          <p>
            We kindly ask all guests to wear formal black attire to help create
            a cohesive and elegant atmosphere—and most importantly, to allow the
            bride to truly stand out on this special day.
          </p>
          <p>
            Your adherence to this dress code means the world to us and will
      ...
      answer: (
        <>
          ...
          <div className="guideline-section">
            ...
            <p>
              <strong>Details:</strong> Patterns or textures (lace, sequins,
              etc.) are welcome as long as the primary color is black.
            </p>
            <p>
              <strong>Shoes:</strong> Heels, flats, or dressy sandals in black
              or metallic tones.
            </p>
          </div>
        </>
    ...
    },
    {
      ...
      answer: (
        <ul className="kos">
          <li>Bright colors, jeans, or casual wear.</li>
        </ul>
      ),
    },
    {
      question: "Why All Black?",
      answer: (
        <ul className="kos">
          <li>To create a timeless, unified aesthetic in photos.</li>
          <li>To let the bride's gown shine as the focal point.</li>
          <li>To celebrate the elegance of intentional simplicity.</li>
        </ul>
      ),
    },
  ];
